...
double chiffreMois = 0;
  ...
  Future<void> chargerStatistiques() async {
    ...
    totalPaiements =
        ...
        commandesEnAttente =
    await DatabaseHelper.instance.getNombreCommandesEnAttente();

commandesTerminees =
    await DatabaseHelper.instance.getNombreCommandesTerminees();

chiffreJour =
    await DatabaseHelper.instance.getChiffreAffairesJour();

chiffreMois =
    await DatabaseHelper.instance.getChiffreAffairesMois();
...
StatCard(
  titre: "Aujourd'hui",
  valeur: "${formatMontant(chiffreJour)} FCFA",
  icon: Icons.today,
  color: Colors.indigo,
),
...
StatCard(
  titre: "Ce mois",
  valeur: "${formatMontant(chiffreMois)} FCFA",
